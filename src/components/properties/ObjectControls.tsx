		...
		>
			...
			<ResizablePanel className="px-4 py-2">
				...
				<p className="text-balance text-sm">
					Guidelines allow you to add references grids to the 3D view
					to help with positioning and scaling models. You can add
					guidelines for different planes (XY, XZ, YZ) and adjust
					their spacing and color.
				</p>
